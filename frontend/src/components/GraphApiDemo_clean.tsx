...
const graphServices: GraphApiService[] = [
    {
        ...
        description: 'Get detailed user information from Microsoft Graph API',
        icon: '👤'
    },
    {
        name: 'SharePoint Sites',
        endpoint: '/api/sharepoint/sites',
        description: 'Access SharePoint root site information',
        icon: '🏢'
    }
];
        ...
        <div className="max-w-4xl mx-auto p-6">
            <div className="mb-6">
                ...
                <p className="text-gray-600 mb-4">
                    Test User Profile and SharePoint access using the On-Behalf-Of (OBO) flow.
                </p>
                <button
            ...
            <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <div className="space-y-2 text-sm text-blue-800">
                    <p>• <strong>Graph User Profile:</strong> Requires User.Read permission</p>
                    <p>• <strong>SharePoint Sites:</strong> Requires Sites.Read.All permission (may require admin consent)</p>
                </div>
                <div className="mt-4 p-3 bg-blue-100 rounded-md">
                    <p className="text-sm text-blue-900">
                        <strong>Note:</strong> SharePoint access may require admin consent for your organization. 
                        If you get permission errors, contact your Azure AD administrator.
                    </p>
                </div>
            </div>
        </div>
